...
// setInterval(콜백함수, 시간): 일정 시간 간격으로 함수를 실행하는 자바스크립트 함수
    // 첫번째 매개변수: 일정 시간 후 동작할 함수를 입력
    // 두번째 매개변수: 시간 간격 (1/1000 초)을 입력
    // 반환값: setInterval() 함수의 ID 값을 반환
// setTimeout(콜백함수, 시간): 일정 시간이 흐른 후 함수를 실행하는 자바스크립트 함수
    // 첫번째 매개변수: 일정 시간 후 동작할 함수를 입력
    // 두번째 매개변수: 시간 간격 (1/1000 초)을 입력
    // 반환값: setTimeout() 함수의 ID 값을 반환
    // 일회성!
