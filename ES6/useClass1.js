// ES5에서는 클래스를 정의하는 문법이 없었기 때문에 prototype을 사용하여 클래스처럼 표현하여 사용
// ES6에서 클래스를 정의하기 위한 'class' 키워드가 추가됨
// 자바의 클래스 사용법과 비슷함
// ES6의 클래스의 생성자는 constructor 라는 메서드로 고정되어 있음
// 클래스의 필드는 선언 방법이 2가지
  // 자바의 클래스 필드를 사용하는 방식과 동일하게 선언
  // 클래스의 메서드 안에서 'this.필드명' 형태로 선언
