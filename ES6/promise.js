// promise : 자바스크립트에서 비동기 함수의 동기 방식 처리를 위해서 제공하는 객체
...
// 프로미스는 상태에 따른 실행함수를 4가지를 제공함
  ...
  getData()
    ...
    .catch(function(err){
      console.log(`프로미스 사용 오류 출력 메세지 : ${err}`);
    })
