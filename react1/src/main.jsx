// react 모듈에서 StrictMode 를 불러옴
import {StrictMode} from 'react'
// readct-dom/client 모듈에서 createRoot를 불러옴
...
// return 되는 내용이 2라인 이상일 경우 반드시 ()로 감싸야 함
...
createRoot(document.getElementById('root')).render(
    ...
    <StrictMode>
        ...
        {/* 화면 UI를 구성하는 JSX 문법은 자바스크립트 + XML / HTML 이기 때문에 기본적으로 XML 문법을 따르고 있음 */}
