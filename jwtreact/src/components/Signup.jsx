        ...
        <div className={'col-sm-4 mx-auto'}>
          <form onSubmit={handleSubmit}>
            ...
            <div className={'my-3'}>
              ...
              <input type={'password'} className={'form-control'} id={'user-pw'} name={'userPw'}
                     placeholder={'사용자 PW를 입력하세요'}/>
            </div>
            <div className={'my-3'}>
              <label htmlFor={'user-nick'} className={'form-label'}>사용자 이름 : </label>
              <input type={'text'} className={'form-control'} id={'user-nick'} name={'userNick'}
                     placeholder={'사용자 이름를 입력하세요'}/>
            </div>
            <div className={'my-3'}>
              <label htmlFor={'user-email'} className={'form-label'}>사용자 이메일 : </label>
              <input type={'email'} className={'form-control'} id={'user-email'} name={'userEmail'}
